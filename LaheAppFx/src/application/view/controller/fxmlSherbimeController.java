...
public class fxmlSherbimeController implements Initializable {
...
//		colKilometrat.setCellValueFactory(new PropertyValueFactory<>("kilomatrat"));
	...
	private void clearTablePjeseKembimi() {
		pjese.clear();
	}
	...
	private void clearTableMirembajtje() {
		mMbajtje.clear();
	}
...
//    }
    ...
    void onTableKlientItemSelect(MouseEvent event) {
    	...
    	if(klient != null) {
    		...
    		tableAutomjet.setItems(getMjete());
